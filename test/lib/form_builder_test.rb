    ...
    expected = <<~HTML
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <textarea data-cms-cm-mode="text/x-markdown" id="fragment-test" name="page[fragments_attributes][123][content]">
</textarea>
        </div>
      </div>
    HTML
    ...
    expected = <<~HTML
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <textarea data-cms-rich-text="true" id="fragment-test" name="page[fragments_attributes][123][content]">
</textarea>
        </div>
      </div>
    HTML
